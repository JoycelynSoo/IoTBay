...
<form action="welcome.jsp" method="post" class="login_form">
    ...
    <table class="login_input_box">
        <tr><td><input type="text" name="firstName" placeholder="Enter first name" required="true"></td></tr>
        <tr><td><input type="text" name="lastName" placeholder="Enter last name" required="true"></td></tr>
        ...
        <tr><td><input type="password" name="confirmPassword" placeholder="Re-enter password" required="true"></td></tr>
    </table>
